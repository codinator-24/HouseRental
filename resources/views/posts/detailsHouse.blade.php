<x-layout>
    ...
    {{-- Booking Message Modal - NEW --}}
    <div id="bookingMessageModal" class="fixed inset-0 z-[60] flex items-center justify-center bg-black bg-opacity-50"
        ...
        <div class="bg-white rounded-lg shadow-xl overflow-hidden max-w-md w-full mx-4">
            <div class="px-6 py-4 bg-gray-100 border-b border-gray-200 flex justify-between items-center">
                <h1 id="bookingMessageModalTitle" class="text-xl font-semibold text-gray-700">Send Booking Inquiry
                </h1>
                <button id="closeBookingMessageModalBtn" aria-label="Close booking inquiry modal"

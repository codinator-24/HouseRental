                    ...
                    @forelse ($houses as $house)
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 flex flex-col">
                            ...
                            <div class="p-6 flex flex-col flex-grow">
                                ...
                                <a href="{{ route('Myhouse.edit', $house) }}" class="block w-full mt-auto bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-center transition duration-300">
                                    View Details
                                </a>
                            </div>
                        </div>

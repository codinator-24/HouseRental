                    ...
                    <div>
                        ...
                        <div class="flex items-center mt-2">
                            ...
                            <span id="picture-filename" class="ml-4 text-sm text-gray-500 self-center">No file
                                chosen</span>
>>>>>>> 017bdb811e3609e7c079a2b8fc1a8499b66632f2
                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    class="block w-full px-3 py-3 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"></div>
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <select
                                                            ...
                                                            <option
                                                                value="lordland"
                                                                {{ old('role', 'both') == 'lordland' ? 'selected' : '' }}>
                                                                @lang('words.Landlord')</option>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex items-center mt-2">
                                                            <label
                                                                class="px-4 py-3 bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer">
                                                                <i class="fas fa-user-circle"> </i><span>   Choose File</span>
                                                                <input type="file" name="picture" id="picture" class="sr-only"></label>
                                                                <span id="picture-filename" class="ml-4 text-sm text-gray-500 self-center">No file chosen</span>
                                                            </div>
                                                            @error('picture')
                                                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                                            @enderror
                                                        ...
                                                        <div>
                                                            ...
                                                            {{-- Assuming you have a translation key 'words.IdCard' --}}
                                                            <div class="flex items-center mt-2">
                                                                <label
                                                                    class="px-4 py-3 bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer">
                                                                ...
                                                                <span>Choose File</span>
                                                                <input type="file" name="IdCard" id="IdCard" class="sr-only"></label>
                                                                <span id="idcard-filename" class="ml-4 text-sm text-gray-500 self-center">No file chosen</span>
                                                            </div>
                                                            @error('picture')
                                                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                                            @enderror
                                        ...
                                        <script>
                                            ...
                                            if (pictureInput) {
                                                pictureInput.addEventListener('change', function () {
                                                    if (this.files && this.files.length > 0) {
                                                        pictureFilenameSpan.textContent = this
                                                            .files[0]
                                                            .name;
                                                    } else {
                                            ...
                                            if (idCardInput) {
                                                idCardInput.addEventListener('change', function () {
                                                    if (this.files && this.files.length > 0) {
                                                        idCardFilenameSpan.textContent = this
                                                            .files[0]
                                                            .name;
                                                    } else {

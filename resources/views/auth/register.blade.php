<x-layout>
    ...
    <div class="mx-auto max-w-screen-sm card">
        ...
        <form action="{{ route('register') }}" method="post" enctype="multipart/form-data">
            ...
            {{-- First Phone Number --}}
            <div class="mb-4">
                <label for="first_phoneNumber">First Phone Number</label>
            ...
            {{-- Second Phone Number --}}
            <div class="mb-4">
                <label for="second_phoneNumber">Second Phone Number (Optional)</label>
            ...
            <div class="mb-4">
                ...
                <select name="role" id="role"
                    ...
                    <option value="tenant" {{ old('role', 'both') == 'tenant' ? 'selected' : '' }}>Tenant</option>
                    <option value="lordland" {{ old('role', 'both') == 'lordland' ? 'selected' : '' }}>Landlord
                    </option>
                    <option value="both" {{ old('role', 'both') == 'both' ? 'selected' : '' }}>Both</option>
                </select>
                @error('role')
                    <p class="error">{{ $message }}</p>
                @enderror

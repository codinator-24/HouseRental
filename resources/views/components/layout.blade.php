...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.5.0/css/flag-icon.min.css"
        integrity="sha512-Cv93isEugYPAeDxPMAvkH0XCBsZRpEDcXeL3nwUbYwNEKh7RRe6FTKiVXRZBStQFOxK+L3iP8Nw9M2r8MhXoGA=="
            ...
            <div class="px-5 pt-2 pb-3 border-t border-gray-200">
                ...
                <div class="mt-1 space-y-1" x-data="{ langOpenMobile: false }">
                    <button @click="langOpenMobile = !langOpenMobile"
                        ...
                        <span>
                            @if (app()->getLocale() == 'en')
                                <img src="{{ asset('images/flags/ENG.PNG') }}" alt="ENG Flag"
                                    class="inline w-5 h-auto mr-2">
                                <span>ENG</span>
                            @elseif (app()->getLocale() == 'ckb')
                                <img src="{{ asset('images/flags/KRD.svg') }}" alt="KRD Flag"
                                    class="inline w-5 h-auto mr-2">
                                <span>KRD</span>
                            @else
                                <i class="fa-solid fa-language"></i>
                    ...
                    <div x-show="langOpenMobile" class="pl-3 mt-1 space-y-1 border-l border-gray-200">
                        <a href="{{ url('set/lang/en') }}"
                            ...
                            <img src="{{ asset('images/flags/ENG.PNG') }}" alt="ENG Flag" class="w-5 h-auto mr-2">
                            ENG
                        </a>
                        <a href="{{ url('set/lang/ckb') }}"
                            ...
                            <img src="{{ asset('images/flags/KRD.svg') }}" alt="KRD Flag" class="w-5 h-auto mr-2">
                            KRD
                        </a>
                    </div>
                </div>
        ...
        function currencySwitcher() {
            return {
                ...
                formatPrice(amount, currencyCode, config) {
                    ...
                    const formattedValue = Number(valueToFormat).toLocaleString(
                        undefined, { // Use browser's locale for number formatting initially
                    ...
                    if (targetCurrency === 'IQD') {
                        finalFormattedValue = Number(valueToFormat.toFixed(formatDetails.decimals)).toLocaleString(
                            'en-US', {
                                minimumFractionDigits: formatDetails.decimals,
                                maximumFractionDigits: formatDetails.decimals,

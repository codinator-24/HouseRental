                    ...
                    <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <button class="btn-accept" onclick="approveHouse({{ $house->id }})">Accept</button>
                                    <button class="btn-reject" onclick="rejectHouse({{ $house->id }})">Reject</button>
                                </div>
                            </td>
                        </tr>
                    @endforeach 
    ...
    <script>
        ...
        function approveHouse(houseId) {
            if (confirm('Are you sure you want to approve this house rental?')) {
                ...
                // You can make an AJAX call to your Laravel route here
                // Example:
